              ...
              <div className="p-6">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-[#1E1E1E] rounded-lg text-gray-300 hover:bg-[#FFB400]/10 hover:text-[#FFB400] transition-colors duration-300"
                  >
